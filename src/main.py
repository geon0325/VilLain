...
##### Config #####
config = '{}_{}_{}_{}_{}_{}_{}_{}_{}_{}'.format(args.dataset, args.dim, args.num_labels, args.num_step, args.num_step_gen, args.learning_rate, args.tau, args.gb_hard, args.pca, args.split)
...
##### Read Data #####
H, labels = utils.load(args.dataset, args.split)
...
##### Prepare Training #####
our_model = model.model(V_idx, E_idx, V, E, num_subspace, args.num_labels, args.num_step, args.num_step_gen, args.tau, args.gb_hard).to(device)
optimizer = optim.AdamW(our_model.parameters(), lr=args.learning_rate, weight_decay=0)
